...
@Tag(
        name = "CRUD REST APIs for Loans in AliBank",
        description = "CRUD REST APIs in AliBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside AliBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @PostMapping("/loans/{mobileNumber}")
    ...
    @DeleteMapping("/loans/{mobileNumber}")
